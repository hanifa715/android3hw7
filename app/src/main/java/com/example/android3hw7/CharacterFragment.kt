...
import com.example.android3hw7.databinding.FragmentCharacterBinding
...
class CharacterFragment : Fragment() {
    ...
    private fun onItemClick(position:Int){
        findNavController().navigate(R.id.detailsFragment, bundleOf("key" to characterList[position]))
    }
